...
import (
	core "github.com/aneshas/gocask/core"
...
// Move provides a mock function with given fields: path, src, dst
func (_m *FS) Move(path string, src string, dst string) error {
	ret := _m.Called(path, src, dst)
...
// OTruncate provides a mock function with given fields: _a0, _a1
func (_m *FS) OTruncate(_a0 string, _a1 string) (core.File, error) {
	ret := _m.Called(_a0, _a1)

	var r0 core.File
	if rf, ok := ret.Get(0).(func(string, string) core.File); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
